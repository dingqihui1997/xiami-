...
const AddRotation = (props: props) => {
    ...
    const [title, settitle] = React.useState(props.data && props.data.title && props.data.title)
    const [link, setlink] = React.useState(props.data && props.data.link && props.data.link)
