...
const AddRotation = (props: props) => {
    ...
    let defaultFileList = props.data
    // defaultFileList: [
    //     {
    //         uid: '1',
    //         name: 'xxx.png',
            ...
            <Card>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Upload {...defaultFileList} name="logo" headers={{ Authorization: localStorage.getItem('token')! }} action="http://localhost:7001/admin/upload" listType="picture" onPreview={onPreview}>
