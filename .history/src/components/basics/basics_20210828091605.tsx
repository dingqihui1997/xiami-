    ...
    return (
        <div className={`${styles.basics}`}>
            ...
            >
                ...
                >
                    <Upload maxCount={1} className="mal20" name="logo" headers={{ Authorization: localStorage.getItem('token')! }} action="http://localhost:7001/admin/upload" listType="picture" onChange={onPreview}>
