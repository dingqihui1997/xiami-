    ...
    return (
        <div className={`${styles.basics}`}>
            ...
            >
                ...
                >
                    <Upload showUploadList maxCount={1} className="mal20" headers={{ Authorization: localStorage.getItem('token')! }} action="http://localhost:7001/admin/upload" listType="picture" onChange={onPreview}>
