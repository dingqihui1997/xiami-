...
const EditRotation = (props: props) => {
    ...
    let [url, seturl] = useState(props.data ? props.data.url : '')
    console.log(url);
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    >
                        <Upload showUploadList={false} name="logo" headers={{ Authorization: localStorage.getItem('token')! }} action="http://localhost:7001/admin/upload" listType="picture" onPreview={onPreview}>
                            <div className={`${style.upload}`}>点击上传图片</div>
                        </Upload>
                        <div>
                            <Image
                                width="200"
                                src='http://lp-disk.oss-cn-chengdu.aliyuncs.com/egg-oss-demo/41zyqtckihq0000.jpg'
                            />
                        </div>
                    </Form.Item>
                    <Form.Item
