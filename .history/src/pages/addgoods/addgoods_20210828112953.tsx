...
const Addgoods = () => {
    ...
    let addgoods = () => {
        ...
        //     type: 'Goods/addGoods',
        //     payload: {
        //          name:basics.name, category:basics.category[length-1], pic:pic, video, cover:basics.cover.file.response.data, originalPrice:basics.originalPrice, presentPrice:basics.presentPrice, discount:'', detail, spec:spec, introduction:basics.introduction, company:basics.company, stock:basics.stock, isNewGood:basics.isNewGood, isHot:basics.isHot, isRecommend:basics.isRecommend, comment:[], isShow:true, sellDesc:basics.sellDesc, productionDesc:""
        //     }
        // })
    }
    return (
