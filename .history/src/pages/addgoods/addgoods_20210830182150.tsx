...
import Norms from './../../../.history/src/pages/norms/norms_20210827150714';
const Addgoods = () => {
        ...
        <div>
            {show ?
                <Card>
                    ...
                    <GoodsDetails Norms={Norms && Norms.data} visible={visible} onCancel={onCancel} data={data}></GoodsDetails>
                </Card> :
                <Card>
