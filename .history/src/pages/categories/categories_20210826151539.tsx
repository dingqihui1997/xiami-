                    ...
                    <div className="flex1">
                        <DirectoryTree
                            ...
                            titleRender={(data: any) => {
                                return <span className={`${style.spantitle}`} style={{ display: 'block', width: 762, zIndex: 99999 }}>
                                    <span className={`${style.spantitle}`} style={{ display: 'block', width: 762, zIndex: 999999 }}> {data.title}</span>
                                    {data.isShow ?
