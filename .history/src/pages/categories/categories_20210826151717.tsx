                    ...
                    <div className="flex1">
                        <DirectoryTree
                            ...
                            titleRender={(data: any) => {
                                return <span className={`${style.spantitle}`} style={{ display: 'inline-block', width: 762, zIndex: 99999 }}>
                                    <span className={`${style.spantitle}`} style={{ display: 'inline-block', width: 762, zIndex: 999999 }}> {data.title}</span>
                                    {data.isShow ?
                                        <span className={`${style.spanbox} flex-end font-w7  margin-r20`}>
                                            <span className="margin-r10">新增</span>
