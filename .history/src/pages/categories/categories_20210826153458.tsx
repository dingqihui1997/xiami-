                    ...
                    <div className="flex1">
                        <DirectoryTree
                            ...
                            titleRender={(data: any) => {
                                return <span className={`${style.spantitle} nowap`} style={{ display: 'inline-list-item', width: 762, zIndex: 999999 }}>
                                    <span className={`${style.spanone} nowap`} > {data.title}</span>
                                    {data.isShow ?
                                        <span className={`${style.spanbox}  nowap flex-end font-w7  margin-r20`}>
