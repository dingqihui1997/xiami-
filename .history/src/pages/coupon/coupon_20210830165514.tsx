    ...
    let handleOk = () => {//欧克按钮
        ...
        if (!data) {
            ...
            dispatch({
                ...
                payload: { name: values.name, amount: values.amount, threshold: values.threshold, start_time: values.start_time._d, end_time: values.end_time._d, number: values.number, id: id }
            })
        }
        setVisible(false)
    }
    ...
    return (
        <div>
            <Card>
                ...
                <Modal visible={visible} title={data && data ? '编辑优惠券' : '添加优惠券'} onOk={submit}
                    onCancel={onCancel}
                    destroyOnClose={true}
                    ...
                    >
                        ...
                        >
                            <DatePicker defaultValue={data && data ? data.start_time : ""} showTime onChange={onChange} onOk={onChange} placeholder="请选择开始时间" style={{ width: 380 }} />
                        </Form.Item>
                        <Form.Item
                            className="mal10"
                            label="结束时间"
                        ...
                        >
                            <DatePicker defaultValue={data && data ? data.end_time : ""} showTime onChange={endonChange} onOk={endonChange} placeholder="请选择开始时间" style={{ width: 380 }} />
                        </Form.Item>
                        <Form.Item
                            className="mal10"
                            label="发放数量"
