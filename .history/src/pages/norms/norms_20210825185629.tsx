            ...
            <Card>
                ...
                <Modal visible={visible} title={data ? '编辑模型' : '新增规格'} onOk={onOk}
                    ...
                    >
                        ...
                        <Form.Item className="flex" name="gender" label="所属模型" rules={[{ required: true }]}>
                            <Select
                                placeholder="请选择所属模型"
                                onChange={onGenderChange}
                                allowClear
                        ...
                        <Form.Item label="规格项" name="guige" rules={[{ required: true }]}>
                            <Input.TextArea />
                        </Form.Item>
                        <Form.Item name="zhanshi" rules={[{ required: true }]} label="展示文字">
                            <Radio.Group name="radiogroup" >
                                <Radio value="text">文字</Radio><Radio value="text">图片</Radio><Radio value="text">颜色</Radio>
                            </Radio.Group>
                        </Form.Item>
                    </Form>
                </Modal>
