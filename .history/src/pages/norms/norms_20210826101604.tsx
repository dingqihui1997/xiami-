...
import { Card, Select, Button, Radio, Divider, Input, Form, Table, DatePicker, Modal, Upload, Image, Pagination, Popconfirm } from 'antd';
...
const Norms = () => {
    ...
    let [modelid, setmodelid] = useState(location && location.id ? location.id : null)
                ...
                <Form form={form} preserve={false} >
                    <div className="flex">
                        <div className="margin-r10">
                            <Form.Item initialValue={modelid} className="flex" style={{ width: 400 }} name="gender" label="所属模型" rules={[{ required: true }]}>
                                <Select
                                    placeholder="请选择所属模型"
                        ...
                        <div>
                            ...
                            <Button htmlType="reset" icon={<UndoOutlined />} onClick={onReset}>重置</Button>
                        </div>
                    </div>
                </Form>
                <Divider />
