...
const Rotation = () => {
    ...
    const [data, setdata] = React.useState<any>()//编辑传值
    ...
    return (
        <div>
            <Card>
                ...
                <Button type="primary" style={{ marginLeft: 20 }} onClick={() => { setVisible(true), setdata(null), setnum(1) }}>添加轮播图</Button>
                <AddRotation visible={visible} modify={modify} addok={addok} data={data} num={num}></AddRotation>
