...
const Seckill = () => {
    ...
    let handleOk = () => {//表单验证成功
        ...
        dispatch({
            ...
            payload: { start_time: values.start_time, end_time: values.end_time, goods_number: values.goods_number, price: values.price, goods: values, isShow: true }
        })
        setVisible(false)
    }
